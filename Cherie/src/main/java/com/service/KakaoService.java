	...
	// 사용자정보를 가져오기 위한 토큰을 발급해줍니다.
		// 아직 사용자 정보 가져오기 전! 로그인만 된 상태입니다.
	     public String getAccessToken (String authorize_code) {
		       ...
		       **************************************/
		        ...
		        /***************************************
		      	 * POST 요청에 필요로 요구하는 파라미터 스트림을 통해 전송 
		           ...
		           sb.append("&client_id=a62ed0a2955c8bc21f644fd281a46439");  // 발급받은 key
	               sb.append("&redirect_uri=http://localhost:8090/kakaoLogin"); // 설정해 놓은 경로
	       ...
	       public HashMap<String, Object> getMemInfo(String access_Token) {
