...
<body>
	<div class="text-center">
		<h2 class="pt-5">MY JEWELRY</h2>
		<%-- 검색 기능 --%>
		<form method="get" action="${contextPath}/jewelry/bySeller" role="form">
			<input type="hidden" value="${sessionScope.loginfo_seller.sellEmail}" id="jewSellEmail" name="jewSellEmail">
						...
						<figure>
							<div class="card h-100">
								...
								<div class="card-body p-4">
									<h5 class="fw-bolder">${list.jewName}</h5> ₩&nbsp;${list.jewPrice}
								</div>

								<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
									<div class="text-center">
										<a class="btn btn-outline-dark mt-auto"
											href="${contextPath}/jewelry/update?jewIdx=${list.jewIdx}">View More</a>
									</div>
								</div>
							</div>
						</figure>
