		...
		<div class="cd-tabs">
			<nav>
				<ul class="cd-tabs-navigation">
					<li><a href="${contextPath}/buyer/signup" class="selected">개인회원</a></li>
					<li><a href="${contextPath}/seller/signup">사업자회원</a></li>
				</ul>
			</nav>
			...
			<form method="post" action="${contextPath}/buyer/signup">
				...
				<%-- buyEmail --%>
				<div class="col-sm-12">
					<label for="buyEmail" class="col-sm-2 pt-4">이메일* </label>
					<%-- 카카오 회원가입 시 sessionScope.k_email로 카카오계정의 이메일 주소를 받아옵니다.--%>
					<input type="text" placeholder="이메일" class="form-control" name="buyEmail" id="buyEmail"
